                    ...
                    <div class="card" id="filter_inputs">
                        <div class="card-body pb-0">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Enter Permission Description">
                                    </div>
                                </div>
                                ...
                                @foreach ($permissions as $permission)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="me-3"
                                                href="
                                                {{-- {{ route('permissions.edit', ['id' => $permission->id]) }} --}}
                                                ">
                                            ...
                                            <a
                                                href="#"
                                                {{-- onclick="event.preventDefault(); deletePermission('{{ route('permissions.destroy', ['id' => $permission->id]) }}')" --}}
                                                >
